...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities["ca.police.example.com"];
        ...
        const identity = X509WalletMixin.createIdentity("PoliceMSP", enrollment.certificate, enrollment.key.toBytes());
