...
#peer channel create -o orderer0.lean.com:7050 /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/lean.com/orderers/orderer0.lean.com/msp/tlscacerts/tlsca.lean.com-cert.pem -c mainchannel -f ./channel-artifacts/channel.tx
sleep 10
echo
